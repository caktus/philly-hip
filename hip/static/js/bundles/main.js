  ...
  function manageSideBarLinks() {
    ...
    function getParentSidebarLink(currentPath) {
      ...
      */
      ...
      if (breadcrumbUL) {
        var breadcrumbElements = breadcrumbUL.getElementsByTagName("li");
        ...
        for (var i = breadcrumbElements.length - 2; i >= 0; i--) {
          ...
          if (currentPath.includes(sideBarLinkHref)) {
            var actualSidebarLink = document.querySelector("[data-href=\"".concat(sideBarLinkHref, "\"]"));
      ...
      var intersectionHandler = function intersectionHandler(entry) {
        ...
        */
        ...
        if (rightScrollLinkClicked === "false") {
          ...
          var elementCurrentlyActive = document.querySelector(".nav-title a.is-current-hip");
          var elementBecomingActive = document.querySelector(".nav-title[data-ref=".concat(id, "] a"));
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  var allRows = document.querySelectorAll("[data-condition]");
  ...
  function filterRightSideLinks(rows) {
    ...
    var allRightSideLinks = document.querySelectorAll("[data-ref]");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function getInternalAlertsFieldNameForDivisionOption(option) {
    ...
    return _defineProperty(_defineProperty(_defineProperty({}, internalAlertsAmbulatoryOptionValue, internalAlertsAmbulatoryFieldName), internalAlertsDiseaseControlOptionValue, internalAlertsDiseaseControlFieldName), internalAlertsEnvironmentalOptionValue, internalAlertsEnvironmentalFieldName)[option.value];
  }
