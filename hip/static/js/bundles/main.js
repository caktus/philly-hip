...
/* harmony import */ var _apps_hip_static_js_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _apps_hip_static_js_sidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _apps_hip_static_js_rightScrollNav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
/* harmony import */ var _apps_hip_static_js_mobileSearchModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
/* harmony import */ var _apps_hip_static_js_loggedInDropdown__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9);
/* harmony import */ var _apps_health_alerts_static_js_healthAlertFilter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(10);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_apps_hip_static_js_sidebar__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_apps_hip_static_js_mobileSearchModal__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_apps_hip_static_js_loggedInDropdown__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_apps_hip_static_js_rightScrollNav__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_apps_health_alerts_static_js_healthAlertFilter__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function manageDocumentLinks() {
    ...
    */
    ...
    var documentLinks = links.filter(function (link) {
      return link.href.includes("document");
    });
    documentLinks.forEach(function (link) {
      var documentIcon = link.parentElement.nextElementSibling;
  ...
  function addExternalLinkIconsAndDomain() {
     ...
     */
    var externalLinks = Array.from(document.querySelectorAll('a.external-linktype')).filter(function (link) {
      // If the link's href's domain name is different from the window.location.host,
      // then it's an external link.
      var domainName = link.href.split("://").pop().split("/")[0];
    ...
    var parentsThatGetDomainForExternalLink = Array.from(document.querySelectorAll('.external-links-with-domains-hip'));
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        link.appendChild(span); // Is this link contained within one of the parentsThatGetDomainForExternalLink?

        var needToAddDomain = false;

        var _iterator2 = _createForOfIteratorHelper(parentsThatGetDomainForExternalLink),
            _step2;
        ...
        if (needToAddDomain === true) {
          ...
          domainSpan.innerHTML = "(".concat(domainName, ")");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function navbarBurger() {
    ...
    navbarBurger.addEventListener("click", function () {
      ...
      if (target.classList.contains("is-hidden-touch")) {
        (0,_common__WEBPACK_IMPORTED_MODULE_0__.openMobileModal)(target);
      } else {
        (0,_common__WEBPACK_IMPORTED_MODULE_0__.closeMobileModal)(target);
      }
    });
  }
  ...
  function setUpMobileSearchModal() {
    ...
    */
    var searchMobileBtn = document.querySelector("#search-mobile-btn");
  ...
  function showMobileSearchModal() {
    ...
    var isSearchPage = document.querySelector(".search-page-hip");
    var width = Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0);

    if (isSearchPage && width < 1024) {
      var searchModal = document.querySelector("#searchMobileContainer");
      (0,_common__WEBPACK_IMPORTED_MODULE_0__.openMobileModal)(searchModal);
    }
  }
}
;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addClickEventListenerBasedOnClassName": () => (/* binding */ addClickEventListenerBasedOnClassName),
/* harmony export */   "closeMobileModal": () => (/* binding */ closeMobileModal),
/* harmony export */   "openMobileModal": () => (/* binding */ openMobileModal)
/* harmony export */ });
function openMobileModal(target) {
  // target: element to open as a modal
  target.classList.remove("is-hidden-touch");
  document.body.classList.add('modal-is-open-hip'); // un-stick the header

  var header = document.getElementById("mobile-header-hip");
  header.classList.remove("is-sticky-hip");
}
;
function closeMobileModal(target) {
  // target: element representing the modal to close
  target.classList.add("is-hidden-touch");
  document.body.classList.remove('modal-is-open-hip'); // re-stick the header

  var header = document.getElementById("mobile-header-hip");
  header.classList.add("is-sticky-hip");
}
;
function addClickEventListenerBasedOnClassName(className, handleClick) {
  var selectedElements = Array.from(document.getElementsByClassName(className));

  for (var _i = 0, _selectedElements = selectedElements; _i < _selectedElements.length; _i++) {
    var el = _selectedElements[_i];
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function manageSideBarLinks() {
    var sideNavLinks = document.querySelectorAll(".sidenav-link-hip");

    function removeIsActive() {
      /* Find the active sidebar element and remove the is-active-hip class
      */
      var isActiveEl = document.querySelector(".is-active-hip");
    ...
    function getParentSidebarLink(currentPath) {
      ...
      */
      var breadcrumbUL = document.querySelector("#breadcrumb-ul-hip");

      if (breadcrumbUL) {
        var breadcrumbElements = breadcrumbUL.getElementsByTagName("li"); // Loop through the breadcrumb elements backwards, and try to find a match
        ...
        for (var i = breadcrumbElements.length - 2; i >= 0; i--) {
          var parentBreadCrumb = breadcrumbElements[i];
          var sideBarLink = parentBreadCrumb.getElementsByTagName("a")[0];
          var sideBarLinkHref = sideBarLink.getAttribute("href");

          if (currentPath.includes(sideBarLinkHref)) {
            var actualSidebarLink = document.querySelector("[data-href=\"".concat(sideBarLinkHref, "\"]")); // If the document has an element with a data-href of the actualSidebarLink,
    ...
    sideNavLinks.forEach(function (sideNavLink) {
      return sideNavLink.addEventListener("click", function () {
        removeIsActive(); // now make the clicked element display as being active

        this.classList.add("is-active-hip"); // relocate the user
    ...
    var sidebarEl = document.querySelector("[data-href=\"".concat(currentPath, "\"]"));
    var parentSideBarEl = getParentSidebarLink(currentPath);
  ...
  function manageCloseButtonClicked() {
    ...
    */
    var closeBtn = document.querySelector(".sidebar-close-btn-hip");
    closeBtn && closeBtn.addEventListener("click", function () {
      var target = document.getElementById("sidebarContent");
      (0,_common__WEBPACK_IMPORTED_MODULE_0__.closeMobileModal)(target);
    });
  }
}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
   ...
   */
  var rightScrollNavContainer = document.querySelector(".right-scroll-container-hip");

  if (rightScrollNavContainer) {
    (0,_common__WEBPACK_IMPORTED_MODULE_0__.addClickEventListenerBasedOnClassName)("right-scroll-link-hip", function (element) {
      var elementCurrentlyActive = document.querySelector(".nav-title a.is-current-hip"); // disable intersection handler
    ...
    var pageSections = Array.from(document.querySelectorAll("div.nav-heading-hip"));

    if (pageSections.length) {
      var intersectionHandler = function intersectionHandler(entry) {
        ...
        */
        var rightScrollLinkClicked = rightScrollNavContainer.dataset.isclicked;

        if (rightScrollLinkClicked === "false") {
          var id = entry.target.id;
          var elementCurrentlyActive = document.querySelector(".nav-title a.is-current-hip");
          var elementBecomingActive = document.querySelector(".nav-title[data-ref=".concat(id, "] a")); // Give the 'is-current-hip' CSS class from the nav title that is becoming non-active.
      ...
      var lastSection = pageSections.pop();
      var options = {
      ...
      var lastSectionObserver = new IntersectionObserver(function (entries, self) {
      ...
      }, lastSectionOptions); // Observe each of the pageSections (except the last one)
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function closeMobileSearchModal() {
    ...
    */
    var closeBtn = document.querySelector(".mobile-search-close-btn-hip");
    closeBtn.addEventListener("click", function () {
      ...
      var initialUrl = urlParams.get('initial_url');

      if (initialUrl) {
        window.location.href = initialUrl;
      } else {
        // they haven't clicked around the search results, so we can just close the modal
        var target = document.getElementById("searchMobileContainer");
        (0,_common__WEBPACK_IMPORTED_MODULE_0__.closeMobileModal)(target);
      }
    });
  }
...
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var loggedInBtn = document.querySelector("#logged-in-dropdown-btn");
  ...
  function manageDropdownIsActiveClickEvent(btn) {
    var dropdown = document.querySelector("#logged-in-dropdown");
    btn.addEventListener("click", function () {
      var dropdownIsActive = dropdown.classList.contains("is-active");
...
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var hasHealthAlerts = document.querySelector('.alert-table-hip');
  var healthAlertSignUpEl = document.querySelector(".health-alert-subscriber-modal");
  var selectConditionEl = document.querySelector('.select-condition');
  var alertsMissingEl = document.querySelector(".alerts-missing-hip");
  var tableHeaderEl = document.querySelector(".alert-table-header-hip");
  var allRows = document.querySelectorAll("[data-condition]"); // the select element is only on the health alerts page

  var isHealthAlertsPage = selectConditionEl;
  var isDiseaseAndConditionDetailPage = hasHealthAlerts && !isHealthAlertsPage;

  if (isHealthAlertsPage && !healthAlertSignUpEl) {
    // do an initial render on page load to stripe the rows properly
    var initialRows = getInitialRows();
    renderRows(initialRows); // add a change event handler to the select dropdowns

    selectConditionEl.addEventListener('change', function (event) {
      var selectedCondition = event.target.value;
      var matchString = "";

      if (selectedCondition !== 'All') {
        matchString += "[data-condition~=\"".concat(selectedCondition, "\"]");
      }

      if (matchString === "") {
        renderRows(allRows);
      } else {
        var rowsToShow = document.querySelectorAll(matchString);
  ...
  function getInitialRows() {
    ...
    var urlParams = new URLSearchParams(window.location.search);
    var initialCondition = urlParams.get('condition');

    if (initialCondition) {
      // change the select dropdown to show this condition
      selectConditionEl.value = initialCondition;
      return document.querySelectorAll("[data-condition~=\"".concat(initialCondition, "\"]"));
    } else {
      return allRows;
    }
  }
  ...
  function restripeRows(rows) {
    var greyClass = "row-bg-grey-hip";
    var whiteClass = "row-bg-white-hip";
    var currentClass = whiteClass;
    var nextClass = greyClass;
    rows.forEach(function (row) {
      if (row.dataset.year !== undefined) {
        ...
        // swap the colors
        var _ref = [nextClass, currentClass];
        currentClass = _ref[0];
        nextClass = _ref[1];
      }
  ...
  function filterRightSideLinks(rows) {
    ...
    var allRightSideLinks = document.querySelectorAll("[data-ref]"); // hide all the right side links

    allRightSideLinks.forEach(function (row) {
      return row.hidden = true;
    });
    rows.forEach(function (row) {
      // find all of the "year" values and unhide those rightsidelinks
      if (row.dataset.year !== undefined) {
        var rightSideLink = document.querySelector("[data-ref=section-".concat(row.dataset.year, "]"));
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var closeBtnArray = Array.from(document.querySelectorAll(".health-alert-close-btn-hip"));
  ...
  function closeBtnClicked(elArray) {
    var _iterator = _createForOfIteratorHelper(elArray),
        _step;
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var notificationSubscriberEl = document.querySelector(".notification-signup-modal");
  var mobileHeader = document.getElementById("mobile-header-hip");
  ...
  function styleInputElements() {
    var formSections = document.querySelectorAll(".form-sections-hip");

    var _iterator = _createForOfIteratorHelper(formSections),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var section = _step.value;
        var inputs = Array.from(section.getElementsByTagName("input"));
  ...
  function closeBtnClicked() {
    var closeBtn = document.querySelector("#notification-signup-close-btn-hip");
    closeBtn.addEventListener("click", function () {
      window.location.href = this.dataset.href;
    });
  }
  ...
  var internalAlertsAmbulatoryOptionValue = "Ambulatory Health Services";
  var internalAlertsAmbulatoryFieldName = "Ambulatory Health Center";
  var internalAlertsAmbulatoryElementSelector = "#id_ambulatory_health_center";
  var internalAlertsDiseaseControlOptionValue = "Division of Disease Control";
  var internalAlertsDiseaseControlFieldName = "Disease Control Program";
  var internalAlertsDiseaseControlElementSelector = "#id_disease_control_program";
  var internalAlertsEnvironmentalOptionValue = "Environmental Health Services";
  var internalAlertsEnvironmentalFieldName = "EHS Program";
  var internalAlertsEnvironmentalElementSelector = "#id_ehs_program";

  function getInternalAlertsFieldNameForDivisionOption(option) {
    var _internalAlertsAmbula;

    // Given an <option> for the "Division" field, return the field name for that option.
    return (_internalAlertsAmbula = {}, _defineProperty(_internalAlertsAmbula, internalAlertsAmbulatoryOptionValue, internalAlertsAmbulatoryFieldName), _defineProperty(_internalAlertsAmbula, internalAlertsDiseaseControlOptionValue, internalAlertsDiseaseControlFieldName), _defineProperty(_internalAlertsAmbula, internalAlertsEnvironmentalOptionValue, internalAlertsEnvironmentalFieldName), _internalAlertsAmbula)[option.value];
  }
  ...
  function hideInternalAlertFormExtraFields() {
    ...
    document.querySelectorAll(".form-sections-hip").forEach(function (element) {
  ...
  function hideInternalAlertFormExtraFieldsExcept(fieldName) {
    ...
    hideInternalAlertFormExtraFields(); // Show the field for the fieldName.

    showField(fieldName);
  }

  var internalAlertsFormDivisionSelect = document.querySelector("#internal-alerts-subscriber-form #id_division");
  ...
  if (internalAlertsFormDivisionSelect) {
    ...
    internalAlertsFormDivisionSelect.querySelectorAll("option").forEach(function (element) {
      if (element.selected === true) {
        var fieldName = getInternalAlertsFieldNameForDivisionOption(element);
    ...
    internalAlertsFormDivisionSelect.addEventListener("change", function (event) {
      internalAlertsFormDivisionSelect.querySelectorAll("option").forEach(function (element) {
        if (element.selected === true) {
          var fieldName = getInternalAlertsFieldNameForDivisionOption(element);
          hideInternalAlertFormExtraFieldsExcept(fieldName);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var contactInformationEditModal = document.querySelector(".contact-information-edit-modal");
  var mobileHeader = document.getElementById("mobile-header-hip");
  ...
  function closeBtnClicked() {
    var closeBtn = document.querySelector("#contact-information-edit-close-btn-hip");
    closeBtn.addEventListener("click", function () {
      window.location.href = this.dataset.href;
    });
  }
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/**
 * Javascript files must be imported here.
 * Webpack uses this file as the entry-point for bundling.
 */
